...
namespace Leap.Unity.Interaction
{
    ...
    [ExecuteInEditMode]
    public class InteractionManagerLeftDown : MonoBehaviour, IInternalInteractionManager,
                                                     IRuntimeGizmoComponent
    {
        ...
        private static InteractionManagerLeftDown s_instance;
        ...
        public static InteractionManagerLeftDown instance
        {
            get
            {
                if (s_instance == null) { s_instance = FindObjectOfType<InteractionManagerLeftDown>(); }
                return s_instance;
            }
